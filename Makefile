...
CFLAGS = -c -std=c++17 -ffreestanding -O2 -Wall -Wextra -fno-stack-protector -lstdc++ -fno-rtti -fno-exceptions
...
iso: install
	$(CC) -T link.ld -o iso/boot/crep.bin -ffreestanding -O2 -nostdlib Bin/boot.o Bin/irt.o $(srcO) -lgcc
