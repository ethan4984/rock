...
srcC = Kernel/kernel.cpp Kernel/shitio.cpp Kernel/port.cpp Kernel/interrupt.cpp Kernel/keyboard.cpp Kernel/memory.cpp Kernel/shell.cpp
srcO = Bin/kernel.o Bin/port.o Bin/shitio.o Bin/irt.o Bin/interrupt.o Bin/keyboard.o Bin/memory.o Bin/shell.o
