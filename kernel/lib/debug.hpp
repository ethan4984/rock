...
//inline tty_formatter global_tty_formatter;

}

template <typename ...Args>
void print(const char *str, Args && ...args) {
    /*if(tty::tty_list.size() > 0) {
        lib::print_format<lib::tty_formatter>(lib::global_tty_formatter, str, args...);
    }*/
